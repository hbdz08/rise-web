...
import { canDeleteCampaign, canPublishCampaign, roleLabel } from "@/lib/permissions";
          ...
          <Space>
            ...
            {record.status === "draft" ? (
              <Button
                ...
                type="warning"
                icon={<IconSend />}
                disabled={!canPublishCampaign(role, record.status)}
            ...
            {record.status === "draft" ? (
              <Button
                ...
                type="danger"
                icon={<IconDelete />}
                disabled={!canDeleteCampaign(role, record.status)}
